  ...
  return (
    ...
    <div className="fixed inset-0 w-screen h-screen overflow-hidden pointer-events-none bg-black">
      ...
      <div className="absolute inset-0 w-full h-full z-0">
        <div className="absolute top-20 left-10 w-72 h-72 bg-gradient-to-r from-green-500 to-black rounded-full mix-blend-screen filter blur-3xl opacity-80 animate-blob"></div>
