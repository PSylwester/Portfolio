            ...
            <div className="contact-content-wrapper flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="contact-text-content text-left max-w-lg">
                ...
                <p className="contact-description mt-6 text-gray-400">
                  Hi there!👋 Thanks for stopping by my space on the web. I believe your work—and
                  the ideas behind it—matter. That's why I'm here: to listen, help, and collaborate
                  without any corporate formalities. Whether you have a big idea or just a quick
                  question, feel free to drop me a line via email or message here ✒️. No pressure at
                  all, just good communication. I usually reply quickly, and who knows? Maybe one
                  day we'll even meet for a real coffee to brainstorm together! 😄
                </p>
              </div>
              ...
              >
                <div className="contact-form-glass">
                  <div className="contact-form-header mb-6">
                    <h3 className="contact-form-title text-xl font-semibold text-white">
                      Contact Me!
                    </h3>
                  </div>
